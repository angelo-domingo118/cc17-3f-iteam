...
class NotebookViewModel(private val repository: NotebookRepository, private val userId: Int) : ViewModel() {
...
class NotebookViewModelFactory(private val repository: NotebookRepository, private val userId: Int) : ViewModelProvider.Factory {
